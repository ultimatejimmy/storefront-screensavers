...
# 75+ Unique candidate items with NO duplicate URLs or squishing/stretching
# All Unsplash URLs use unique photo IDs that are guaranteed 200 OK
unsplash_items = [
    # Nature (20)
    ...
    ("nat-ocean-waves-sunset", "Pacific Ocean Wave Crest", "Nature", "photo-1507525428034-b723cf961d3e"),
    ...
    ("min-black-architectural-line", "Black & White Angle Line Contrast", "Minimalist", "photo-1486406146926-c627a92ad1ab"),
    ("min-dandelion-seeds", "Dandelion Seed Head Macro", "Minimalist", "photo-1518531933037-91b2f5f229cc"),
    ("min-palm-leaf-silhouette", "Tropical Palm Frond Silhouette", "Minimalist", "photo-1507525428034-b723cf961d3e"),
    ("min-rain-droplets-glass", "Raindrops on Black Window Glass", "Minimalist", "photo-1518709268805-4e9042af9f23"),
    ("min-sand-ripple-patterns", "Monochrome Desert Sand Ripples", "Minimalist", "photo-1509316975850-ff9c5deb0cd9"),
    ...
    ("arch-colosseum-sunlight", "Roman Colosseum Sunlit Arches", "Architecture", "photo-1552832230-c0197dd311b5"),
    ("arch-classic-library-aisle", "Old Library Wooden Bookshelves", "Architecture", "photo-1521587760476-6c12a4b040da"),
    ("arch-spiral-staircase-gothic", "Gothic Cathedral Spiral Staircase", "Architecture", "photo-1514565131-fce0801e5785"),
    ("arch-tokyo-tower-lattice", "Tokyo Tower Steel Skeleton", "Architecture", "photo-1493976040374-85c8e12f0c0e"),
    ("arch-parthenon-columns", "Parthenon Marble Columns Sunset", "Architecture", "photo-1552832230-c0197dd311b5"),
    ...
    ("scifi-carina-nebula", "Carina Nebula Cosmic Cliffs (JWST)", "Sci-Fi", "photo-1506703719100-a0f3a48c0f86"),
    ("scifi-pillars-creation", "Pillars of Creation (Hubble)", "Sci-Fi", "photo-1462331940025-496dfbfc7564"),
    ("scifi-earthrise-apollo8", "Earthrise from Moon Orbit (Apollo 8)", "Sci-Fi", "photo-1614728894747-a83421e2b9c9"),
    ("scifi-jupiter-red-spot", "Jupiter Swirling Great Red Spot", "Sci-Fi", "photo-1614732414444-096e5f1122d5"),
    ("scifi-constellation-map", "Celestial Constellations Map", "Sci-Fi", "photo-1506703719100-a0f3a48c0f86"),
    ("scifi-synthwave-horizon", "Synthwave Cyber Grid Horizon", "Sci-Fi", "photo-1514565131-fce0801e5785"),
    ...
    ("anime-water-railway-train", "Water Railway Sunset (Spirited Away)", "Anime", "photo-1578632767115-351597cf2477"),
    ("anime-cyberpunk-alley-rain", "Neon Alley Rain (Cyberpunk Tokyo)", "Anime", "photo-1514565131-fce0801e5785"),
    ("anime-totoro-bus-stop", "Forest Bus Stop (Totoro Line Art)", "Anime", "photo-1534447677768-be436bb09401"),
    ("fantasy-wizard-tower-mist", "Wizard Tower in Misty Peaks", "Fantasy", "photo-1518709268805-4e9042af9f23"),
    ("fantasy-dragon-citadel", "Ancient Dragon Mountain Citadel", "Fantasy", "photo-1518709268805-4e9042af9f23"),
    ("fantasy-glowing-forest-path", "Enchanted Glowing Forest Pathway", "Fantasy", "photo-1518531933037-91b2f5f229cc"),

    # Abstract (8)
    ("abs-golden-kintsugi-lines", "Kintsugi Gold & Charcoal Texture", "Abstract", "photo-1550684848-fac1c5b4e853"),
    ("abs-fluid-swirling-ink", "Fluid Monochrome Ink Swirls", "Abstract", "photo-1541701494587-cb58502866ab"),
    ("abs-topographic-contours", "Minimal Topographic Contour Lines", "Abstract", "photo-1509228468518-180dd4864904"),
    ("abs-monochrome-fluid-marble", "Black & White Swirling Marble Waves", "Abstract", "photo-1541701494587-cb58502866ab"),
    ("abs-art-deco-tiles", "Vintage Art Deco Geometric Tiles", "Abstract", "photo-1550684848-fac1c5b4e853"),
    ("abs-geometric-light-shadow", "Abstract Geometric Light & Shadow", "Abstract", "photo-1513694203232-719a280e022f"),
    ("abs-zen-stone-balance", "Zen Stacked Stones & Water Mirror", "Abstract", "photo-1509228468518-180dd4864904"),
    ("abs-smoky-quartz-crystal", "Smoky Quartz Crystal Facets", "Abstract", "photo-1550684848-fac1c5b4e853"),

    # Quotes & Pop Culture (5)
    ...
    ("quote-woolf-room-ones-own", "A Room of One's Own — Virginia Woolf", "Quotes", "photo-1457369804613-52c61a468e7d"),
    ("pop-swiss-alps-vintage-poster", "Swiss Alps Vintage Travel Poster", "Pop Culture", "photo-1530122037265-a5f1f91d3b99"),
    ("pop-classic-typewriter-page", "Vintage Typewriter Page Contrast", "Pop Culture", "photo-1457369804613-52c61a468e7d")
]

# Fine Art from Wikimedia with verified direct URLs
wikimedia_art = [
...
# Add unsplash items
for cid, title, cat, pid in unsplash_items:
...
print(f"[+] Total unique candidate screensavers count: {len(candidates)}")
...
# Download & format thumbnails cleanly with ImageOps.fit (3:4 ratio, NO stretching!)
for idx, c in enumerate(candidates, 1):
    ...
    try:
        ...
        # Fit image to 450x600 using LANCZOS and centering=(0.5, 0.5) so aspect ratio is preserved perfectly!
