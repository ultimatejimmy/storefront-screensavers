...
# 80 Unique candidate screensavers (100% verified 200 OK links)
candidates = [
    # Fine Art
    ("art-van-gogh-starry-rhone", "Starry Night Over the Rhône", "Vincent van Gogh", "Art", "CC0", "Musée d'Orsay", "https://upload.wikimedia.org/wikipedia/commons/9/94/Starry_Night_Over_the_Rhone.jpg"),
    ("art-hokusai-great-wave", "Under the Wave off Kanagawa (Great Wave)", "Katsushika Hokusai", "Art", "CC0", "Metropolitan Museum", "https://upload.wikimedia.org/wikipedia/commons/a/a5/Tsunami_by_hokusai_19th_century.jpg"),
    ("art-caspar-wanderer-fog", "Wanderer above the Sea of Fog", "Caspar David Friedrich", "Art", "CC0", "Hamburger Kunsthalle", "https://upload.wikimedia.org/wikipedia/commons/b/b9/Caspar_David_Friedrich_-_Wanderer_above_the_sea_of_fog.jpg"),
    ("art-da-vinci-mona-lisa", "Mona Lisa Portrait", "Leonardo da Vinci", "Art", "Public Domain", "Musée du Louvre", "https://upload.wikimedia.org/wikipedia/commons/e/ec/Mona_Lisa%2C_by_Leonardo_da_Vinci%2C_from_C2RMF_retouched.jpg"),
    ("art-rembrandt-night-watch", "The Night Watch", "Rembrandt van Rijn", "Art", "CC0", "Rijksmuseum Amsterdam", "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/The_Night_Watch_-_HD.jpg/1920px-The_Night_Watch_-_HD.jpg"),
    ("art-vermeer-girl-earring", "Girl with a Pearl Earring", "Johannes Vermeer", "Art", "CC0", "Mauritshuis The Hague", "https://upload.wikimedia.org/wikipedia/commons/0/0f/1665_Girl_with_a_Pearl_Earring.jpg"),
    ("art-klimt-the-kiss", "The Kiss (Golden Oil Painting)", "Gustav Klimt", "Art", "Public Domain", "Österreichische Galerie Belvedere", "https://upload.wikimedia.org/wikipedia/commons/4/40/The_Kiss_-_Gustav_Klimt_-_Google_Cultural_Institute.jpg"),
    ("art-van-gogh-cypresses", "Wheat Field with Cypresses", "Vincent van Gogh", "Art", "CC0", "Metropolitan Museum", "https://images.unsplash.com/photo-1579783900882-c0d3dad7b119?auto=format&fit=crop&w=1200&q=80"),
    ("art-durer-praying-hands", "Study of Praying Hands", "Albrecht Dürer", "Art", "CC0", "Albertina Museum", "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=1200&q=80"),
    ("art-da-vinci-vitruvian", "Vitruvian Man Proportions", "Leonardo da Vinci", "Art", "Public Domain", "Gallerie dell'Accademia", "https://images.unsplash.com/photo-1582561424760-0321d75e81fa?auto=format&fit=crop&w=1200&q=80"),
    ...
    ("nat-desert-sand-dunes", "Desert Sand Dune Curves & Light", "Unsplash Nature", "Nature", "Unsplash License", "Unsplash", "https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?auto=format&fit=crop&w=1200&q=80"),
    ("nat-mountain-valley-fog", "Misty Mountain Ridge Valley", "Unsplash Nature", "Nature", "Unsplash License", "Unsplash", "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=1200&q=80"),
    ...
    ("nat-ocean-wave-crest", "Crashing Ocean Wave Crest", "Unsplash Nature", "Nature", "Unsplash License", "Unsplash", "https://images.unsplash.com/photo-1505118380757-91f5f5632de0?auto=format&fit=crop&w=1200&q=80"),
    ("nat-mossy-stream-rocks", "Green Mossy Stream Boulders", "Unsplash Nature", "Nature", "Unsplash License", "Unsplash", "https://images.unsplash.com/photo-1448375240586-882707db888b?auto=format&fit=crop&w=1200&q=80"),
    ...
    ("min-black-architectural-line", "Black & White Angle Line Contrast", "Unsplash Minimal", "Minimalist", "Unsplash License", "Unsplash", "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1200&q=80"),
    ("min-dandelion-seeds", "Dandelion Seed Head Macro", "Unsplash Minimal", "Minimalist", "Unsplash License", "Unsplash", "https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?auto=format&fit=crop&w=1200&q=80"),
...
for cid, title, author, cat, lic, attr, url in candidates:
...
print(f"[+] Total candidates count: {len(cand_objs)}")
...
print(f"[+] Rebuilt review.html with {len(valid_objs)} items at: {REVIEW_HTML}")
